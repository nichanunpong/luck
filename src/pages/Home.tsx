        ...
        <div className='mx-auto max-w-6xl px-8 md:px-10 pt-10 lg:pt-32 pb-16 grid lg:grid-cols-2 gap-10 items-center'>
          <div className='order-2 lg:order-2 -mt-2 md:-mt-4 lg:-mt-38'>
            ...
            <p className='text-sm sm:text-base lg:text-[18px] my-6'>
              ...
              data-driven decision making, and stakeholder management to deliver
              products that achieve measurable business results
            </p>
          ...
          <div className='mt-6 grid md:grid-cols-2 gap-6 items-center'>
            ...
            <div className='pl-4'>
              ...
              <p className='mt-3 text-gray-700'>
                I developed event website features, including a QR code check-in
                system for 500+ participants. I collaborated with
          ...
          <div className='mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch'>
            <div className='bg-neutral-800 p-3 border border-gray-700 shadow-sm transition-colors duration-200 hover:bg-neutral-900 hover:border-gray-500 hover:shadow-md flex flex-col h-full'>
              ...
              <p className='mt-4 text-sm text-gray-300'>
                ...
                development of an e-commerce platform that improved the flow of
            ...
            <div className='bg-neutral-800 p-3 border border-gray-700 shadow-sm transition-colors duration-200 hover:bg-neutral-900 hover:border-gray-500 hover:shadow-md flex flex-col h-full'>
              ...
              <p className='mt-4 text-sm text-gray-300'>
                ...
                technology projects that improved operations and delivery across
                departments.
              </p>
              <div className='mt-auto pt-5'>
                <Link
            ...
            <div className='bg-neutral-800 p-3 border border-gray-700 shadow-sm transition-colors duration-200 hover:bg-neutral-900 hover:border-gray-500 hover:shadow-md flex flex-col h-full'>
              ...
              <p className='mt-4 text-sm text-gray-300'>
                ...
                projects that streamlined processes and delivered quality
                results.
              </p>
              <div className='mt-auto pt-5'>
                <Link
          ...
          <div className='mt-10 grid md:grid-cols-3 gap-10 items-start'>
            <div>
              ...
              <p className='mt-2 text-gray-700'>
                The Support Store dashboard visualizes the annual sales report,
                helping the owner understand their customers and increase sales.
              </p>
              <div className='mt-4'>
                <a
            ...
            <div>
              <h3 className='text-2xl md:text-2xl font-semibold'>Flashcard</h3>
              <div className='mt-6 rounded-2xl overflow-hidden shadow-lg bg-black'>
                <img
                  src={flashcard}
                  alt='Flashcard App'
              ...
              <p className='mt-2 text-gray-700'>
                A fast and lightweight flashcard web app with spaced repetition.
                Create your own cards, play interactive games, and tap to hear
            ...
            <div>
              ...
              <p className='mt-2 text-gray-700'>
                An interactive dashboard visualizing building permits issued by
                the City of Vancouver. Explore annual permit trends, and project
                values through dynamic charts and filters.
              </p>
              <div className='mt-4'>
                <a
